...
export default function Terminal({ onComplete }: { onComplete: () => void }) {
  ...
  const terminalLines = [
    ...
    "Daniel Unah",
    "ls -F experience/",
    "EDUrain/  Atlassian/  WashU-TA/  General-Motors/  TKC-Holdings/  WashU-STS/",
    "ls -F projects/",
    "ScheduleSync/  Goat-Tracker/  Chelsea-Fan-App/  Wave-Survival/",
    "cat skills.txt",
    "Python, Java, React, TypeScript, SQL, Spring Boot, Unity...",
